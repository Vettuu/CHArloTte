...
La grafica dell'app è personalizzata. Nell'immagine della home, a schermo intero, può essere inserita la grafica dell'evento e il logo di uno sponsor.
Echelon Italia fornisce l'app completa di tutti i contenuti e di tutte le informazioni, inserendo i relatori e gli interventi del programma, gli sponsor e gli abstract, e si occupa anche della pubblicazione dell'app nello store e dell'invio ai partecipanti dell'evento della email con il link per scaricare l'app.
Tutti i contenuti, il programma, i relatori e le informazioni possono essere aggiornati in tempo reale tramite back-end. Echelon Italia fornisce assistenza tecnica anche durante l'evento, gestendo le funzioni interattive dell'app e provvedendo all'aggiornamento dei contenuti dell'app.
Il partecipante deve scaricare l'app dallo store di Apple o di Android. Echelon Italia può fornire all'organizzatore un Qrcode, da stampare sul programma dell'evento o proiettato in sala, inquadrando il quale il partecipante accede velocemente allo store per scaricare l'app. Inoltre Echelon Italia può inviare una email in modo massivo a tutti i partecipanti all'evento con il link per scaricare l'app e l'eventuale password da inserire per effettuare il login e attivare tutte le funzioni interattiva. Dopo avere scaricato l'app l'utente dovrà fare il log-in inserendo alcuni dati (email, nome e cognome) oppure inserendo una password fornita da Echelon Italia per email unitamente al link per scaricare l'app. La comodità di una app nativa, rispetto ad una web-app, è anche quella di poter accedere all'app molto velocemente, cliccando l'icona presente sulla home del proprio dispositivo.

## Pagine e funzioni
Le pagine e funzioni che si possono includere nell'app solo: informazioni (pagina di informazioni generali e logistiche), programma dell'evento, agenda personalizzata, abstract delle relazioni, lista degli sponsor, lista dei luoghi del congresso, collegamenti ai social dell'organizzatore o dell'evento, notifiche push, instant poll, domande dal pubblico, galleria fotografica, elenco relatori con biografia e fotografia, questionari e customer satisfaction, networking tra partecipanti. Oltre a queste, tante altre funzionalità e pagine potranno essere create e inserite nell'app.

## Networking tra i partecipanti dell'evento
...
## Luoghi di interesse
Sezione luoghi di interesse con elenco per tipologia.
Apertura di Google Maps con il luogo puntato al click.

## Relatori
Elenco dei relatori e scheda personale di ogni relatore con la fotografia, la biografia e gli interventi previsti nel programma dell'evento.
...
Il costo delle singole funzioni extra richieste sono i seguenti:
- lista degli sponsor: 625 euro
- elenco relatori con biografia e fotografia: 750 euro
- collegamenti ai social dell'organizzatore o dell'evento: 500 euro
